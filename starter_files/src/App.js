              ...
              <div className="card-block">
                ...
                <form onSubmit={this.handleFormSubmit}>
                  <div className="form-group">
                    <textarea className="form-control" onChange={this.handleCommentTextChange} value={this.state.commentText} name="comment"  rows="3" type="text" />
                  </div>
                  <div className="form-group">
                    <input className="form-control col-md-3" onChange={this.handleNameChange} value={this.state.author} name="name"  type="text"/>
                  </div>
